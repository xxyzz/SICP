...
(define ordinary-b (make-scheme-number 2))
(define rational-a (make-rational 1 2))
(define rational-b (make-rational 3 4))
(define rectangular-a (make-complex-from-real-imag 1 2))
(define rectangular-b (make-complex-from-real-imag 1 0))
(define polar-a (make-complex-from-mag-ang 1 2))
(define polar-b (make-complex-from-mag-ang 1 0))

(eqn? ordinary-a ordinary-a) ; #t
(eqn? ordinary-a ordinary-b) ; #f
(eqn? ordinary-a rational-a) ; #f
(eqn? rational-a rational-a) ; #t
(eqn? rational-a rational-b) ; #f
(eqn? rectangular-a rectangular-a) ; #t
(eqn? rectangular-a rectangular-b) ; #f
(eqn? rectangular-a polar-a) ; #f
(eqn? polar-a polar-a) ; #t
(eqn? polar-a polar-b) ; #f
(eqn? rectangular-b polar-b) ; #t
